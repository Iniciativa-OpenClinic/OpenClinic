          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.82rem', textAlign: 'left' }}>
            <thead>
              <tr style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0', color: '#475569', fontWeight: 600 }}>
                <th style={{ padding: '10px 14px' }}>{t('GLOBAL_LABEL_NAME')}</th>
                <th style={{ padding: '10px 14px' }}>Token / Key</th>
                <th style={{ padding: '10px 14px' }}>Scope</th>
                <th style={{ padding: '10px 14px' }}>{t('GLOBAL_LABEL_STATUS')}</th>
                <th style={{ padding: '10px 14px' }}>{t('API_KEYS_COL_EXPIRATION')}</th>
              </tr>
            </thead>
            <tbody>
              <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                <td style={{ padding: '12px 14px', fontWeight: 600, color: '#0f172a' }}>Clinical Sync Integration</td>
                ...
                <td style={{ padding: '12px 14px', color: '#64748b' }}>{t('API_KEYS_NO_EXPIRATION')}</td>
              </tr>
              <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
