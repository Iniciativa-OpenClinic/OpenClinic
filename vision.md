...
*v0.1 — documento vivo, escrito na fase de fundação do projeto.*
...
**API aberta como pilar fundacional.** A API não é um recurso adicionado depois — é parte do desenho original do sistema. Robusta, bem documentada e pública. O padrão técnico de referência pretendido é o **HL7 FHIR**, por ser tanto o padrão exigido pela Rede Nacional de Dados em Saúde (RNDS) quanto o padrão internacional de interoperabilidade em saúde. A implementação concreta será definida com a comunidade técnica.
